...
public class LoginScreen extends javax.swing.JFrame {
    ...
    private void submitButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_submitButtonActionPerformed
        // TODO add your handling code here:
        if(usernameField.getText().equals("1234") && passwordField.getText().equals("4321"))  //button action listener set to accept generic values for the time being (until user accounts are fully implemented)
        {
            new MenuScreen().setVisible(true);   //will open the menu screen upon successful login and dispose of login screen
            dispose();
        }
        else
        {
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ...
                LoginScreen menuFrame = new LoginScreen();
                //menuFrame.setExtendedState(JFrame.MAXIMIZED_BOTH);  //this will automatically make the screen full sized at startup
